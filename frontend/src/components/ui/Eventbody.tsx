  ...
  return (
    <section className="mx-6 mt-5 space-y-3">
      <div className="flex flex-col lg:flex-row justify-center lg:gap-x-32 space-y-8 lg:space-y-0">
        ...
        <div className="flex flex-col items-center gap-12  lg:items-start max-w-md">
          ...
          <h1 className="text-lg font-bold font-work-sans text-[#262626]">
            Featured stories
          </h1>
          <div className="bg-[#EDEDED] p-3 flex flex-col lg:flex-row justify-between items-center border rounded-xl  lg:space-y-0">
            <div className="text-center lg:text-left">
              <h1 className="text-[#262626] text-xl font-normal font-work-sans">
                Download for a better experience
              </h1>
